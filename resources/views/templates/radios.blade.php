...
@push('head')
    ...
    <style>
        ...
        .rd-hero { background: linear-gradient(135deg, #f8f9fa, #e9ecef); padding: 50px 0; margin-bottom: 40px; }
        ...
        .rd-hero .btn-shop { display: inline-block; padding: 12px 32px; background: #ff6600; color: #fff; text-decoration: none; font-weight: 600; border-radius: 4px; transition: all 0.3s; }
        .rd-hero .btn-shop:hover { background: #e55a00; }
        ...
        .rd-product .name { font-size: 14px; font-weight: 600; color: #333; margin: 6px 0; line-height: 1.3; }
        ...
        .rd-product .btn-cart { display: block; width: 100%; padding: 10px; background: #ff6600; color: #fff; border: none; font-weight: 600; cursor: pointer; margin-top: 12px; border-radius: 4px; text-decoration: none; text-align: center; transition: all 0.3s; }
        ...
        .rd-sidebar-box ul { list-style: none; padding: 0; margin: 0; }
        .rd-sidebar-box ul li { padding: 8px 0; border-bottom: 1px solid rgba(255,255,255,0.1); }
        .rd-sidebar-box ul li a { color: #ccc; text-decoration: none; font-size: 14px; }
        .rd-sidebar-box ul li a:hover { color: #ff6600; }
        .rd-brands { display: flex; justify-content: center; gap: 40px; padding: 40px 0; background: #f9f9f9; margin: 40px 0; flex-wrap: wrap; }
        .rd-brands a { font-size: 16px; font-weight: 700; color: #bbb; text-transform: uppercase; text-decoration: none; transition: color 0.3s; }
        .rd-brands a:hover { color: #ff6600; }
        ...
        .rd-feature h4 { font-size: 14px; font-weight: 700; color: #333; margin: 12px 0 4px; }
    ...
    <section class="rd-hero">
        <div class="container" style="display: grid; grid-template-columns: 1fr 1fr; gap: 40px; align-items: center;">
            <div>
                ...
                <a href="{{ route('shop.index') }}" class="btn-shop">Ver Ofertas</a>
            </div>
    ...
    <div class="container">
        <div class="rd-features">
            <div class="rd-feature">
                <svg style="width:40px;height:40px;color:#ff6600;" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M5 8h14M5 8a2 2 0 110-4h14a2 2 0 110 4M5 8v10a2 2 0 002 2h10a2 2 0 002-2V8m-9 4h4"/></svg>
                <h4>Envio Gratis</h4><p>En compras +$100</p>
            </div>
            <div class="rd-feature">
                <svg style="width:40px;height:40px;color:#ff6600;" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z"/></svg>
                <h4>Garantia Oficial</h4><p>6 a 12 meses</p>
            </div>
            <div class="rd-feature">
                <svg style="width:40px;height:40px;color:#ff6600;" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M3 10h18M7 15h1m4 0h1m-7 4h12a3 3 0 003-3V8a3 3 0 00-3-3H6a3 3 0 00-3 3v8a3 3 0 003 3z"/></svg>
                <h4>Pago Seguro</h4><p>Multiples metodos</p>
            </div>
            <div class="rd-feature">
                <svg style="width:40px;height:40px;color:#ff6600;" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M18.364 5.636l-3.536 3.536m0 5.656l3.536 3.536M9.172 9.172L5.636 5.636m3.536 9.192l-3.536 3.536M21 12a9 9 0 11-18 0 9 9 0 0118 0zm-5 0a4 4 0 11-8 0 4 4 0 018 0z"/></svg>
                <h4>Soporte 24/7</h4><p>WhatsApp y telefono</p>
            </div>
        </div>
    </div>
                ...
                <div class="rd-sidebar-box">
                    ...
                    <ul>
                        @foreach($categories as $cat)
                            <li><a href="{{ route('shop.index', ['category' => $cat->slug]) }}">{{ $cat->name }} ({{ $cat->products_count }})</a></li>
                        @endforeach
                    </ul>
                </div>
                <div class="rd-sidebar-box">
                    ...
                    <ul>
                        @foreach($brands as $brand)
                            <li><a href="{{ route('shop.index', ['brand' => $brand->slug]) }}">{{ $brand->name }}</a></li>
                        @endforeach
                    </ul>
                </div>
            </div>
