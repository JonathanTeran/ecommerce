        ...
        $sections = [
            ...
            [
                ...
                'config' => [
                    ...
                    'metrics' => [
                        ...
                        ['value' => '24/7', 'label' => 'Soporte Técnico', 'icon' => 'support'],
                    ],
                    'style' => [
                        'bg_type' => 'gradient',
                        'bg_gradient_from' => '#0f172a',
            ...
            [
                ...
                'config' => [
                    ...
                    'subheading' => 'Opiniones reales de compradores verificados',
                    'reviews' => [
                        [
                            'author' => 'Carlos M.',
                            'rating' => 5,
                            'text' => 'Compré una laptop ASUS y llegó en perfectas condiciones al día siguiente. El precio fue el mejor que encontré en todo el mercado. Definitivamente volveré a comprar.',
                            'role' => 'Compra verificada',
                        ],
                        [
                            'author' => 'María F.',
                            'rating' => 5,
                            'text' => 'Excelente atención al cliente. Tuve una duda sobre compatibilidad de una RAM y me asesoraron por WhatsApp en minutos. El producto llegó perfecto.',
                            'role' => 'Cliente frecuente',
                        ],
                        [
                            'author' => 'José R.',
                            'rating' => 4,
                            'text' => 'Armé mi PC gaming con componentes de esta tienda. Buenos precios en procesadores y tarjetas de video. La garantía me da tranquilidad.',
                            'role' => 'Compra verificada',
                        ],
                        [
                            'author' => 'Ana T.',
                            'rating' => 5,
                            'text' => 'Necesitaba un cargador urgente para mi laptop Dell y lo conseguí el mismo día. Calidad original y buen precio. Muy recomendado.',
                            'role' => 'Compra verificada',
                        ],
                        [
                            'author' => 'Luis P.',
                            'rating' => 5,
                            'text' => 'Las cámaras de seguridad Hikvision que compré funcionan de maravilla. La instalación fue sencilla y la app funciona perfecta. Gran compra.',
                            'role' => 'Cliente desde 2024',
                        ],
                        [
                            'author' => 'Gabriela M.',
                            'rating' => 4,
                            'text' => 'Compré la impresora Epson EcoTank y estoy encantada. El sistema de tinta continua ahorra muchísimo. Envío rápido y bien empacado.',
                            'role' => 'Compra verificada',
                        ],
                    ],
                    'style' => [
            ...
            [
                ...
                'config' => [
                    ...
                    'subheading' => 'Distribuidores autorizados de las marcas líderes del mercado',
                    'style' => [
                        'bg_type' => 'solid',
                        'bg_color' => '#ffffff',
                        'text_color' => '#374151',
            ...
            [
                ...
                'name' => 'Newsletter',
                'config' => [
                    'heading' => 'No te pierdas ninguna oferta',
                    'subheading' => 'Suscríbete y recibe un cupón de 10% de descuento en tu primera compra',
                    'button_text' => 'Suscribirme Gratis',
                    'benefit_items' => [
